...
try:
    ...
    if not test_query.empty:
        ...
        connection_error = True
        error_message = "La consulta de prueba no devolvió resultados"
...
SOLUCIÓN:
1. Ve a https://neon.tech y verifica que tu base de datos esté activa
2. En Streamlit Cloud, ve a Settings → Secrets
3. Elimina cualquier configuración existente
4. Agrega EXACTAMENTE esta línea (con TUS datos):
